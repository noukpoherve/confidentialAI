...
(function initI18n(global) {
  ...
  const MESSAGES = {
    en: {
      ...
      opt_domain_dup: "This domain is already in your list.",
    ...
    fr: {
      ...
      opt_domain_dup: "Ce domaine est déjà dans votre liste.",
